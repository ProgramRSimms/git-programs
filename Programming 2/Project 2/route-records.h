...
typedef struct RouteRecord{
    char origin, destination, airline;
    int countArr [];//array of passenger count /*There are six months’ worth of data for each route. (Index 0 will represent January’s passenger count, Index 1 will represent February’s passenger count, etc.).*/
}RouteRecord;
